    ...
    <header className="relative py-4 lg:px-20 px-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={"/nidlp/orders/all"}>
          <button className="hidden md:flex items-center gap-2 border-2 border-gray-200 rounded-lg px-5 py-2 hover:border-blue-400 hover:text-blue-400 transition duration-300 text-sm cursor-pointer">
            <LogIn size={16} />
            تسجيل الدخول
          </button>
          </Link>
