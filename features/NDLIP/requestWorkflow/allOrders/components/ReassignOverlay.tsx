...
const MOCK_EMPLOYEES: Employee[] = [
  { id: 1, name: 'عبدالله فهد العتيبي',    email: 'aotaibi@nidlp.gov.sa', avatar:"/abdullah.png"  },
  { id: 2, name: 'محمد عبدالله الحربي',    email: 'mharby@nidlp.gov.sa', avatar:"/sarah.png"   },
  { id: 3, name: 'نورة خالد القحطاني',     email: 'nqah@nidlp.gov.sa', avatar:"/ahmed.png"     },
  { id: 4, name: 'منيرة عبدالعزيز القامدي', email: 'mghamdi@nidlp.gov.sa', avatar:"/leila.png"  },
]
