...
export const thData: ColumnDef[] = [
  ...
  },
  {
    ...
    filter: {
      ...
      options: [
        { label: "الكل", value: "all" },
        { label: "عبدالله فهد العتيبى", value: "عبدالله فهد العتيبى", photo: "/assets/abdullah2.png" },
        { label: "سارة خالد السعدى", value: "سارة خالد السعدى", photo: "/assets/sarah.png" },
        { label: "احمد احمد الراشد", value: "احمد احمد الراشد", photo: "/assets/ahmed2.png" },
        { label: "فيصل احمد الدوسرى", value: "فيصل احمد الدوسرى", photo: "/assets/anonymous.png" },
        { label: "نورة محمد الشهرى", value: "نورة محمد الشهرى", photo: "/assets/noura2.png" },
        { label: "احمد خالد القحطاني", value: "احمد خالد القحطاني", photo: "/assets/ahmed.png" },
        { label: "نورة سلطان احمد", value: "نورة سلطان احمد", photo: "/assets/nora.png" },
        { label: "ليلى احمد الزهراني", value: "ليلى احمد الزهراني", photo: "/assets/leila.png" },
      ],
      filterFn: (row, value) =>
  ...
  },
  {
    ...
    filter: {
      ...
      options: [
        { label: "الكل", value: "all" },
        { label: "سلة", value: "سلة", photo: "/assets/company-13.png" },
        { label: "مجلس الشراكة اللوجستى", value: "مجلس الشراكة اللوجستى", photo: "/assets/company-14.png" },
        { label: "زاجل", value: "زاجل", photo: "/assets/company-12.png" },
        { label: "مراحل", value: "مراحل", photo: "/assets/company-15.png" },
        { label: "المجدوعى", value: "المجدوعى", photo: "/assets/company-10.png" },
        { label: "ارامكس", value: "ارامكس", photo: "/assets/company-8.png" },
        { label: "امازون", value: "امازون", photo: "/assets/company-1.png" },
        { label: "نون", value: "نون", photo: "/assets/company-11.png" },
      ],
      filterFn: (row, value) =>
